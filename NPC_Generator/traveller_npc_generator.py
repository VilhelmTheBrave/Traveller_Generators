...
DRIFTER_DICT = {BARBARIAN: {ANIMALS, CAROUSE, MELEE, STEALTH, SEAFARER, SURVIVAL},
                WANDERER : {ATHLETICS, DECEPTION, RECON, STEALTH, STREETWISE, SURVIVAL},
...
ENTERTAINER_DICT = {ARTIST    : {ART, CAROUSE, COMPUTERS, GAMBLER, PERSUADE, TRADE},
                    ...
                    PERFORMER : {ART, ATHLETICS, CAROUSE, DECEPTION, STEALTH, STREETWISE},
...
SCHOLAR_DICT = {FIELD_RESEARCHER: {SENSORS, DIPLOMAT, LANGUAGE, SURVIVAL, INVESTIGATE, SCIENCE},
                SCIENTIST       : {ADMIN, ENGINEER, SCIENCE, SENSORS, COMPUTERS},
                PHYSICIAN       : {MEDIC, COMMS, INVESTIGATE, PERSUADE, SCIENCE},
                GENERAL         : {COMPUTERS, COMMS, DIPLOMAT, MEDIC, INVESTIGATE, SCIENCE, ART, ADVOCATE, LANGUAGE, ENGINEER}}
...
def gen_npc_skills(careerInfo):
  ...
  while i < skillPoints:
    ...
    if chosenSkill in skillDict:
      if skillDict[chosenSkill] < 3:
        skillDict[chosenSkill] += 1
        i += 1
    else:
